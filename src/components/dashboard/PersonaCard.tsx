  ...
  return (
    ...
    >
      <Card className="overflow-hidden border-0 bg-card shadow-[var(--shadow-medium)] hover:shadow-[var(--shadow-strong)] transition-all duration-300 h-full flex flex-col">
        ...
        <motion.div 
          className="mt-auto min-h-[180px] space-y-2 pt-4 pb-6 px-6 bg-gradient-to-br from-destructive/10 to-destructive/5 border-t border-destructive/20 rounded-b-lg"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
