...
export function MarketingAdsTab({ recommendations, onGenerateRecommendation, onStatusChange, isGenerating, quota, onOpenFeedback, recosUsage }: Props) {
    ...
    <div className="space-y-5">
      ...
      {recommendations.length === 0 && !isGenerating ? (
        <p className="text-sm text-muted-foreground py-8 text-center">
          Aucune recommandation Ads pour le moment.{!generationBlocked && " Cliquez sur le bouton ci-dessus pour en générer une."}
        </p>
      ) : (
